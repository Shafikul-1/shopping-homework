<template>
    <!-- Loading Section -->
    <div class="center absolute top-0 left-0 w-[100%] h-[100vh] z-20" v-if="loading">
            <div class="wave"></div>
            <div class="wave"></div>
            <div class="wave"></div>
            <div class="wave"></div>
    ...
    <!-- End Loading Secion -->
    <div>
        <section class="py-20 font-poppins dark:bg-gray-800 z-0">
                    ...
                    <div class="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                        <div class="sticky top-0 z-50 overflow-hidden">
                            <div class="relative mb-6 lg:mb-10">
                                ...
                                <img class="object-cover w-full lg:h-1/2" :src="allProduct.thumbnail" alt="" />
                            ...
                            <div class="flex-wrap hidden -mx-2 md:flex">
                                <div class="w-1/2 p-2 sm:w-1/4" v-for="(similarImage, index) in allProduct.images"
                                    :key="index">
                                    <button
                                        class="block border border-transparent hover:border-blue-400 p-1 hover:shadow-lg rounded-md">
                                        <img class="object-cover w-full lg:h-32" :src="similarImage" alt="" />
                                    </button>
                                </div>
                            </div>
                            <!-- User Question -->
                        ...
                        <div class="lg:pl-20">
                            <div class="mb-6">
                                <span class="text-red-500 dark:text-red-200">
                                    <sapn class="font-bold text-black text-xl">Brand:</sapn> New
                                    {{ allProduct.brand }}
                                </span>
                                <h2
                                ...
                                <div class="">
                                    <span class="text-md font-bold capitalize">category: </span>
                                    <RouterLink :to="{ name: 'product-details', params: { id: allProduct.id } }"
                            ...
                            <div class="">
                                ...
                                <div
                                    ...
                                    <div v-for="productColor in productOtherColor" :key="productColor.id">
                                        <button
                                            ...
                                            <div>
                                                <div class="w-8 h-8 mx-auto mb-2 rounded-full"
                                                    :style="{ background: productColor.color }"></div>
                            ...
                            <div class="mt-6">
                                ...
                                <div
                                    ...
                                    <div v-for="capacity in productCapacity" :key="capacity.id">
                                        <button
                            ...
                            <div class="mt-6">
                                ...
                                <div
                                    class="grid grid-cols-2 gap-4 pb-4 mt-2 mb-4 border-b-2 border-gray-300 lg:grid-cols-3 dark:border-gray-600">
                                    <div v-for="pament in pamentMethod" :key="pament.id">
                                        <button
                            ...
                            <div class="mt-6">
                                ...
                                <div class="px-7">
                                    <p class="mb-2 text-md text-green-500 font-bold">In Stock</p>
                                    <p class="mb-2 text-md text-black font-bold">Free Shipping</p>
                                </div>
                            </div>
                            <!--  -->
                            <div class="mt-6">
                                <div class="flex flex-wrap items-center">
                                    ...
                                    <h2 class="text-lg font-bold text-gray-700 dark:text-gray-400">Price</h2>
                                </div>
                                <div class="px-7">
                                    <p class="mb-2 text-md text-black font-bold">
                                        Product Price:
                                        <span class="text-red-500">${{ allProduct.price }}
                                            <sup class="text-green-600">
                                                <small>Discount -{{ allProduct.discountPercentage }}%</small>
                                            </sup>
                                        </span>
                                    </p>
                                    <p class="mb-2 text-md text-black font-bold">
                                        Total Stock: {{ allProduct.stock }} pcs
                                    </p>
                                </div>
                            </div>
                            <!-- Rating ProgressBar -->
                            <div class="mt-6">
                                <div class="flex flex-wrap items-center">
                                    ...
                                    <h2 class="text-lg font-bold text-gray-700 dark:text-gray-400">Rating</h2>
                                </div>
                                <div class="px-7">
                                    <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700">
                                        <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full"
                                            :style="{ width: allProduct.rating + 30 + '%' }">
                                            {{ allProduct.rating }}%
                                        </div>
                                    </div>
                                </div>
...
const productCapacity = [
    {
        ...
        storage: '128',
        size: 'GB',
        otherDetails: 'From $99 0r $41.62/mo. for 24 mo.'
    },
    {
        id: 2,
        storage: '---',
